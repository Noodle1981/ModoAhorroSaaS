                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                @foreach($scenarios as $scenario)
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center {{ $scenario['percent'] == 100 ? 'bg-blue-50' : '' }}">
                                        {{ number_format($scenario['analysis']['usable_area_m2'], 1) }}
                                    </td>
                                @endforeach
                            </tr>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                @foreach($scenarios as $scenario)
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-semibold {{ $scenario['percent'] == 100 ? 'bg-blue-50' : '' }}">
                                        {{ number_format($scenario['analysis']['installable_kwp'], 2) }}
                                    </td>
                                @endforeach
                            </tr>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900">
                                {{ number_format($bestScenario['analysis']['installable_kwp'], 2) }} kWp
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Cobertura</p>
                            <p class="text-lg font-bold text-green-700">
                                {{ number_format($bestScenario['analysis']['coverage_percent'], 1) }}%
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Inversión</p>
                            <p class="text-lg font-bold text-gray-900">
                                ${{ number_format($bestScenario['analysis']['investment_ars'], 0, ',', '.') }}
                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Payback</p>
                            <p class="text-lg font-bold text-blue-700">
                                {{ number_format($bestScenario['analysis']['payback_years'], 1) }} años
                            </p>
                        </div>
                    </div>
