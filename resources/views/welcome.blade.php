                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-xl p-6 border-2 border-blue-300 shadow-lg hover:shadow-xl transition">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Huella de Carbono</h3>
                        </div>
                        <p class="text-gray-600 mb-3">Calcula el impacto ambiental de tu consumo energético. Mide tus emisiones de CO₂ y recibe sugerencias para reducir tu huella ecológica.</p>
                        <span class="inline-block px-3 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full">🚧 En desarrollo</span>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 border-2 border-blue-300 shadow-lg hover:shadow-xl transition">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Medidores Inteligentes</h3>
                        </div>
                        <p class="text-gray-600 mb-3">Integra medidores eléctricos inteligentes para obtener datos en tiempo real. Monitoreo automático sin carga manual de facturas.</p>
                        <span class="inline-block px-3 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full">🚧 En desarrollo</span>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 border-2 border-blue-300 shadow-lg hover:shadow-xl transition">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Análisis ROI</h3>
                        </div>
                        <p class="text-gray-600 mb-3">Calcula el retorno de inversión al cambiar equipos. Estima cuánto recuperas, en cuánto tiempo y la tasa de recupero real de tus mejoras.</p>
                        <span class="inline-block px-3 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full">🚧 En desarrollo</span>
                    </div>
                </div>
            </div>
